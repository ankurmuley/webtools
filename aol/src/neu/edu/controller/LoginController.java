		...
		String nextPage = "FAIL";
		 ...
		 if(userParam==null || passwordParam == null){
			...
			if(user !=null){
			    ...
			    session.setAttribute("name", userSession.getName());
//				System.out.println("Hello"+userSession.getName());
				System.out.println("Need to verify:" + user.getLinesaboutyou());
				session.setAttribute("user", user);
				
				
			}
			
//			ArrayList<UserRegistration> users = userAccountDAO.listAllUsers();
//			UserSession userSession= null;
