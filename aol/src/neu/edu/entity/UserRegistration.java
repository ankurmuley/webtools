...
public class UserRegistration {
	public UserRegistration(String userName, String name, String password, String dob, String gender,
			String linesaboutyou, String emailAddress, String phoneNumber, String address, String project1Name,
			String project1Description, String project2Name, String project2Description, String university,
			String relevantCourses, String company, String position, String jobDescription, String skill1,
			String rateSkill1, String skill2, String rateSkill2, String skill3, String rateSkill3,
			String reference1Name, String reference1Email, String reference1Relation, String reference2Name,
			String reference2Email, String reference2Relation) {
		super();
